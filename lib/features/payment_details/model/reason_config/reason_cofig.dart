import 'package:payfxglobal/features/payment_details/model/required_document/required_document.dart';
...
class ReasonConfig {
  ...
  factory ReasonConfig.fromLegacyJson(Map<String, dynamic> json) {
    ...
    if (name.contains('family maintenance')) {
      rels = ['Father', 'Mother', 'Son', 'Daughter', 'Siblings', 'Spouse', 'Self'];
    } else if (name.contains('living cost')) {
      rels = ['Son', 'Daughter', 'Siblings', 'Spouse'];
    } else if (name.contains('emigration')) {
      rels = ['Self'];
    } else if (name.contains('gift')) {
      rels = ['Father', 'Mother', 'Son', 'Daughter', 'Siblings', 'Spouse', 'Friends', 'Self', 'Any Other Relationship'];
    } else if (name.contains('exam fee')) {
      rels = ['Family', 'Self', 'Relative', 'Partner', 'Friend', 'Seller', 'Donor', 'Employee', 'Buyer', 'Unknown', 'Other'];
    }

    final isGift = name.contains('gift');
    final isFamilyMaintenance = name.contains('family maintenance');
    final showDobField = isGift || isFamilyMaintenance;
    ...
    final isCompany = name.contains('private visit') ||
        name.contains('conference') ||
        name.contains('skill assessment') ||
        name.contains('visa fees') ||
        name.contains('exam fee');
    ...
    if (isTuition) {
      ...
      sectionLabel = 'University Account Details';
      nameLabel = 'University Name (As Per Bank Account)';
      addressLabel = 'University Address';
      bankNameLabel = 'University Bank';
      bankBranchLabel = 'University Bank Branch Name';
      bankAddressLabel = 'University Bank Address';
      mobileLabel = 'University Mobile';
      ...
      bankNameLabel = 'Account Bank';
      bankBranchLabel = 'Account Bank Branch Name';
      bankAddressLabel = 'Account Bank Address';
      mobileLabel = 'Account Mobile';
      emailLabel = 'Account Email';
    } else if (isHospital) {
      recipientType = 'hospital';
      sectionLabel = 'Hospital Account Details';
      nameLabel = 'Hospital Name (as per bank account)';
      addressLabel = 'Hospital Account Address';
      bankNameLabel = 'Hospital Account Bank';
      bankBranchLabel = 'Hospital Account Branch Name';
      bankAddressLabel = 'Hospital Account Bank Address';
      mobileLabel = 'Hospital Mobile';
      emailLabel = 'Hospital Email';
    } else if (isEmigration) {
      recipientType = 'self';
      sectionLabel = 'Self Overseas Account Details';
      nameLabel = 'Self Overseas Account Name';
      addressLabel = 'Self Overseas Account Address';
      bankNameLabel = 'Self Overseas Account Bank';
      bankBranchLabel = 'Self Overseas Account Branch Name';
      bankAddressLabel = 'Self Overseas Account Bank Address';
      mobileLabel = 'Self Overseas Account Mobile';
      emailLabel = 'Self Overseas Account Email';
    } else if (isCompany) {
      recipientType = 'company';
      sectionLabel = 'Company Account Details';
      nameLabel = 'Company Name (as per bank account)';
      addressLabel = 'Company Address';
      bankNameLabel = 'Company Bank';
      bankBranchLabel = 'Company Bank Branch Name';
      bankAddressLabel = 'Company Bank Address';
      mobileLabel = 'Company Mobile';
